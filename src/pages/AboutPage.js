  ...
  render() {
    return (
      <div className={"col-12"}
           style={{backgroundPosition: "top", backgroundSize: "cover", backgroundImage: "url(" + ScottImage + ")"}}>
        <TopBar light={true}/>
          ...
          <div className={"col-12 AboutPageContent DropShadowItem"}>
            <div className={"row"}>
              <div className={"col-12 HoverableExpand"}>
                <div className={"container"}>
                  <br/>
                  <h1>A <span className={"SloganColor"}>16 year-old</span> software engineer & shoutcaster who not only
                    enjoys understanding "<span className={"SloganColor"}>how</span>", but also "<span
                      className={"SloganColor"}>why</span>"</h1>

                  <p>
                    I'm Scott, and I'm from England. I've been programming since the age of 7, and have never looked
                    back.
                    I enjoy writing in as many languages as I can, constantly learning and challenging myself. Through
                    this,
                ...
                <div className={"container"}>
                  <div className={"row"}>
                    ...
                    <div className={"col-md-4"}>
                      ...
                      <p>Full stack web development with PHP / NodeJs, C++, Java (incl. Kotlin & Scala), C#, Swift,
                        React / React Native & many more</p>
                    </div>
                    <div className={"col-md-4"}>
                      <h4>Socials</h4>
                      <p className={"SocialTextClear"}>
                        <a href={"https://instagram.com/scott._h"} target={"_blank"}><i
                          className="fab fa-fw fa-instagram"/> scott._h</a>
                        <br/>
                        <a href={"https://twitter.com/hiettdigital"} target={"_blank"}><i
                          className="fab fa-fw fa-twitter"/> hiettdigital</a>
                        <br/>
