            ...
            <Void>
                <div className={"col-12 ProductGradientTop"}>
                    ...
                    <div className={"container"}>
                        ...
                        <div className="row">
                            <div className={"col-md-6 PortfolioItem"} style={{ color: "black", backgroundColor: "white", borderTopColor: this.mainColor }}>
                                <p className={"PortfolioSubLine"}>GET READY TO</p>
                                <h1>REINVENT HOLIDAY FINANCE</h1>
                                <p>Description</p>

                                <Link to={this.props.targetUrl}>
                                    <button style={{marginTop: 15, borderColor: this.mainColor, color: this.mainColor}} className={"Btn"}>Watch the Video</button>
                                </Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={"container"}>
                        <div className={"row"}>
                            ...
                            <div className={"col-md-8 StageAreaContent RightStageAreaContent"}>
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras tempor, sem in hendrerit posuere, diam lectus placerat urna, at venenatis purus dui eu sem. Curabitur porttitor diam quis finibus molestie. Fusce at urna tortor. Nunc ullamcorper pellentesque nibh sed lacinia. In vel massa facilisis, pellentesque nibh at, tempor ligula. Phasellus ac velit nulla. Nulla sapien enim, condimentum a cursus ut, blandit a purus. In tristique eros ex, ut tempus urna tristique ut. Proin porttitor velit nisi, sit amet efficitur justo porttitor non. Curabitur massa lacus, auctor quis magna sit amet, tincidunt placerat nulla. Aliquam at vestibulum neque, id faucibus arcu.</p>
                            </div>
